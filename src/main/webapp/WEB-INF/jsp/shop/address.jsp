...
<html>
	...
	<base href="${ctx }/">
		...
		<link href="assets/shop/css/addstyle.css" rel="stylesheet" type="text/css">
		<script src="assets/shop/AmazeUI-2.4.2/assets/js/jquery.min.js" type="text/javascript"></script>
				...
				<div class="main-wrap">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content address" data-toggle="distpicker" data-autoselect="3" id="regionPicker">
												<select id="province">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="xiang" rows="3" id="user-intro" placeholder="输入详细地址" name="xiang" id="xiang"></textarea>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a class="am-btn am-btn-danger" type="submit" id="saveadress" href="javascript: void(0)">保存</a>
					...
					<script type="text/javascript">
						...
						$("#saveadress").click(function(){
							...
							var xiang = $(".am-form-content .xiang").val();
							$.ajax({
								url:ctx+"/shop/address",
								method:"post",
								data:{
									username:name,
									phone:phone,
