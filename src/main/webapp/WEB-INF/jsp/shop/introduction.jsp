...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<base href="${ctx }/">
		...
		<link type="text/css" href="assets/shop/css/optstyle.css" rel="stylesheet" />
		<link type="text/css" href="assets/shop/css/style.css" rel="stylesheet" />

		<script type="text/javascript" src="assets/shop/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="assets/shop/basic/js/quick_links.js"></script>

		<script type="text/javascript" src="assets/shop/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<script type="text/javascript" src="assets/shop/js/jquery.imagezoom.min.js"></script>
		<script type="text/javascript" src="assets/shop/js/jquery.flexslider.js"></script>
		<script type="text/javascript" src="assets/shop/js/list.js"></script>
...
<script type="text/javascript" language="javascript"
	src="assets/shop/js/introduct.js"></script>
	</head>
		...
		<div class="am-container header">
			...
			<div class="nav-table">
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="assets/shop/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="assets/shop/images/02.jpg" />
								</li>
								<li>
									<img src="assets/shop/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${commo.picture }"><img src="${commo.picture }" alt="细节展示放大镜特效" rel="${commo.picture }" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${commo.picture }" mid="${commo.picture }" big="${commo.picture }"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>￥</em><b class="sys_item_price">${commo.market }</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>￥</em><b class="sys_item_mktprice">${commo.display }</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="assets/shop/images/songzi.jpg" />
													</div>
													<div class="text-info">
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" href="shop/pay">立即购买</a>
								</div>
							</li>
							
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="javascript:void()" ><i></i>加入购物车</a>
								</div>
							</li>
				...
				$("#LikBasket").click(function(){
					console.log("ffff");
					var Ids  = $(".clearfixRight>.tb-detail-hd span").text();
					var shopname = $(".tb-detail-hd h1").text();
					var username=$(".the-username").text();
					var picture = $(".tb-s310>a>img").attr("src");
					var market = $(".sys_item_price").text();
					var display = $(".sys_item_mktprice").text();
					console.log(Ids);  
				   $.ajax({
						url:ctx + "/shop/shopcart",
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="assets/shop/images/cp.jpg"></a>
							...
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="assets/shop/images/cp2.jpg"></a>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="assets/shop/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="assets/shop/images/tw1.jpg" />
											<img src="assets/shop/images/tw2.jpg" />
											<img src="assets/shop/images/tw3.jpg" />
											<img src="assets/shop/images/tw4.jpg" />
											<img src="assets/shop/images/tw5.jpg" />
											<img src="assets/shop/images/tw6.jpg" />
											<img src="assets/shop/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="assets/shop/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="assets/shop/images/imgsearch1.jpg" />
