...
<div class="page-content clearfix">
    ...
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:ovid()" id="member_add" class="btn btn-warning" style="display:none "><i class="icon-plus"></i>添加用户</a>
	...
	<c:forEach items="${members }" var="mem">
		<tr>
          ...
          <td>${mem.id }</td>
          <td >${mem.username }</td>
          <td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','500','400')">${mem.realname }</u></td>
          <td>${mem.sex }</td>
          <td>${mem.phone }</td>
          <td>${mem.email }</td>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
     <li><label class="label_name">用&nbsp;&nbsp;户 &nbsp;名：</label><span class="add_name"><input value="${mem.username }" name="用户名" type="text"  class="text_add" /></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">真实姓名：</label><span class="add_name"><input name="真实姓名" type="text"  class="text_add" value="${mem.realname }"/></span><div class="prompt r_f"></div></li>
     ...
     <li><label class="label_name">移动电话：</label><span class="add_name"><input name="移动电话" type="text"  class="text_add" value="${mem.phone }"/></span><div class="prompt r_f"></div></li>
     <li><label class="label_name">电子邮箱：</label><span class="add_name"><input name="电子邮箱" type="text"  class="text_add" value="${mem.email }"/></span><div class="prompt r_f"></div></li>
...
$(".btn-danger").click(function() {
	...
	//根据id删除数据
	var checked = $("#users-table tr>td>label>:checked").parent().parent().next();
