...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		...
		<link rel="stylesheet" href="assets/backstage/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="assets/backstage/assets/css/ace-skins.min.css" />
		...
		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='assets/backstage/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
        ...
        <script src="assets/backstage/js/jquery.nicescroll.js" type="text/javascript"></script>
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  location.href=ctx+"/backatage/login";
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>					
						<img src="assets/backstage/images/logo.png" width="470px">
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
               ...
               <ul class="nav ace-nav">	
				...
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
				 <li><a href="javascript:void(0" name="backstage/Systems" title="系统设置" class="iframeurl"><i class="icon-cog"></i>网站设置</a></li>
				 <li><a href="javascript:void(0)" name="backstage/admin_info" title="个人信息" class="iframeurl"><i class="icon-user"></i>个人资料</a></li>
				 <li class="divider"></li>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="javascript:void(0)" name="backstage/home" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="backstage/Products_List"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="backstage/home"> </iframe>
