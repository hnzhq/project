...
<script type="text/javascript" language="javascript" src="assets/backstage/js/add.js">
...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <!-- enctype="multipart/form-data"用于文件上传 -->
	...
	<form action="backstage/picture-add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		...
		<div class=" clearfix cl">
			...
			<div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="place" name="place"></div>
			</div>
            <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="display" name="display" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">促销价：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="market" name="market" >元</div>
			</div>
		</div>
		<%-- <div>
					
			<label for="intime">撰稿日期：</label> <input type="text"
			name="intime" id="intime" placeholder="请输入撰稿日期"
			value="<fmt:formatDate value="${commmodity.intime }" pattern="yyyy-MM-dd" />"
			autocomplete="off">
		...
		<%-- <div class="clearfix cl">
			<label class="form-label col-2">加入时间：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<fmt:formatDate value="${commmodity.intime }" pattern="yyyy-MM-dd" />" placeholder="请输入加入日期" id="intime" name="intime" autocomplete="off">
			</div>
		</div> --%>
		<div class="clearfix cl">
		...
		<div class="clearfix cl">
			<label class="form-label col-2" for="picture-pic">图片上传：</label>
