...
<link href="assets/backstage/assets/css/bootstrap.min.css" rel="stylesheet" />
		...
		<![endif]-->
		<script src="assets/backstage/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="assets/js/html5shiv.js"></script>
		<script src="assets/js/respond.min.js"></script>
		<![endif]-->
        		<!--[if !IE]> -->
		<script src="assets/backstage/assets/js/jquery.min.js"></script>        
		<!-- <![endif]-->
           	<script src="assets/backstage/assets/dist/echarts.js"></script>
...
<div class="page-content clearfix">
 ...
 <div class="clearfix">
  <div class="home_btn">
     <div>
     <a href="backstage/picture-add"  title="添加商品" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-addp.png" /></i>
     <h5 class="margin-top">添加商品</h5>
     </a>
     <a href="backstage/Category_Manage"  title="产品分类" class="btn  btn-primary btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-cpgl.png" /></i>
     <h5 class="margin-top">产品分类</h5>
     </a>
     <a href="backstage/admin_info"  title="个人信息" class="btn  btn-success btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-grxx.png" /></i>
     <h5 class="margin-top">个人信息</h5>
     </a>
     <a href="backstage/Systems"  title="系统设置" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/xtsz.png" /></i>
     <h5 class="margin-top">系统设置</h5>
     </a>
     <a href="backstage/Order_handling"  title="商品订单" class="btn  btn-purple btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-gwcc.png" /></i>
     <h5 class="margin-top">商品订单</h5>
     </a>
     <a href="backstage/picture-add"  title="添加广告" class="btn  btn-pink btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-ad.png" /></i>
     <h5 class="margin-top">添加广告</h5>
     </a>
      <a href="backstage/article_add"  title="添加文章" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="assets/backstage/images/icon-addwz.png" /></i>
