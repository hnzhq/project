...
<link href="assets/backstage/Widget/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <!-- enctype="multipart/form-data"用以文件上传 -->
	<form action="backstage/picture-edit" method="post" class="form form-horizontal"id="form-article-add"  enctype="multipart/form-data">
		...
		<div class=" clearfix cl">
	     ...
	     <div class="formControls col-10"><input type="text" class="input-text" value="${commodity.comname }" placeholder="" id="comname" name="comname"></div>
		</div>
		<div class=" clearfix cl">
			
			<div class="Add_p_s">
            <label class="form-label col-2">*产品编号：</label>
			<div class="formControls col-2"><input type="text" class="input-text" value="${commodity.productID }" placeholder="" id="productID" name="productID"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.place }" placeholder="" id="place" name="place"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">材&nbsp;&nbsp;&nbsp;&nbsp;质：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.material }" placeholder="" id="material" name="material"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.brand }" placeholder="" id="brand" name="brand"></div>
			</div>
             <div class="Add_p_s">
             <label class="form-label col-2">产品重量：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.weight }" placeholder="" id="weight" name="weight" >kg</div>
			</div>
             <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.display }" placeholder="" id="display" name="display" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">促销价：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="${commodity.market }" placeholder="" id="market" name="market" >元</div>
			</div>
		...
		<div class="clearfix cl">
			<label class="form-label col-2" for="picture-pic">修改图片：</label>
			<input type="file" name="picture-pic" id="picture-pic" autocomplete="off">
        ...
        <div>
					<label for="id"> 编号：</label> <input type="text" name="id" id="id"
						readonly="readonly" value="${commodity.id }">
				</div>
		<div class="clearfix cl">
...
<script type="text/javascript" src="assets/backstage/Widget/My97DatePicker/WdatePicker.js"></script> 
<script type="text/javascript" src="assets/backstage/Widget/icheck/jquery.icheck.min.js"></script> 
<script type="text/javascript" src="assets/backstage/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script> 
<script type="text/javascript" src="assets/backstage/Widget/Validform/5.3.2/Validform.min.js"></script> 
<script type="text/javascript" src="assets/backstage/Widget/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="assets/backstage/Widget/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="assets/backstage/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="assets/backstage/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script> 
